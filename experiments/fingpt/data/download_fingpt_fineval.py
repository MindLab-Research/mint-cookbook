#!/usr/bin/env python3
"""Download the public FinGPT Fineval dataset into local JSONL files."""
...
def main() -> int:
    ...
    write_split("train", list(dataset["train"]))
    write_split("test", list(dataset["test"]))
    return 0
